...
export default function Philosophy() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-48 bg-slate-950 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-0 w-[400px] h-[400px] bg-cyan-500/[0.03] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-0 w-[300px] h-[300px] bg-blue-500/[0.03] rounded-full blur-[80px] pointer-events-none" />
